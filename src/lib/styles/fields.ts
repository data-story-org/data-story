const fieldBorder =
  'border border-indigo-500 border-opacity-25 focus:outline-none focus:border-indigo-500 focus:border-opacity-100 hover:border-indigo-500 hover:border-opacity-100:';
